...
int main(int argc, char **argv) {
  ...
  node.param<std::string>("car_name", car_name, std::string("car100"));
  int version = 2;
  ...
  private_node.param<std::string>("odom_frame", odom_frame,
                                  std::string("odom"));
  messenger.odom_frame_ = "/"+car_name+ odom_frame;
  std::string base_frame;
  private_node.param<std::string>("base_frame", base_frame,
                                  std::string("base_link"));
  messenger.base_frame_ = "/"+car_name+ base_frame;
  ...
  messenger.SetupSubscription_multi(car_name);
